...
- 🐾 **牧场系统** - 43种生物，喂食产出，自动收获，卖出换金（v6.0）
...
### 新增功能
- **牧场系统 🐾**：全新游戏模块，43种生物可选，喂食→产出→卖出形成金币闭环
  - 5 种稀有度：普通 / 优秀 / 稀有 / 史诗 / 传说（白/绿/蓝/紫/金）
  - 6 大生物分类：动物类 / 水族类 / 异兽类 / 神话类 / 种族类 / 特殊类
  - 喂食状态机：已购买 → 已饲养 → 饥饿 → 饿死（饥饿3轮自动移除）
  - 经济循环：购买生物 → 喂食消耗金币 → 产出材料入仓库 → 仓库卖出回收金币
- **牧场 Tab UI**：main.py 第9个 Tab，3个区域（商店购买 / 牧场库存 / 产出仓库）

### 新增文件
- \modules/ranch.py\ — 牧场生物数据库（43种，含5种稀有/精英定位）
